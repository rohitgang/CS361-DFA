...
public class DFAState extends fa.State {
	...
	private Set<DFAState> nextStates;
    	private Dictionary nextStateWithTransition;
	...
	private Boolean isStart;
		...
		this.nextStateWithTransition = new HashTable();
 	...
 	*/  
	public void addStateWithTransition(DFAState state, char transition){
